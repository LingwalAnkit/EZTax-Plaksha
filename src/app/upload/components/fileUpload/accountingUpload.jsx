...
export const AccountingFileUpload = ({
  ...
  onSuccess,
  onError,
  apiEndpoint = "/api/ocr/billandExpense",
}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const endpoint =
        selectedDocType === "salary" ? "/api/ocr/salaryOCR" : apiEndpoint;
    ...
    <div className="w-full max-w-2xl mx-auto">
      ...
      <div className="">
        ...
        <p className="text-gray-600 mb-4 montserrat-font-medium">
          Select the type of financial document you're uploading (one category
          only):
        </p>
