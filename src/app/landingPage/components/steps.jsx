...
const Steps = () => {
  return (
    <div className="w-full bg-white pb-32" id="steps">
                ...
                {isLeft ? (
                  <>
                    <div className="w-5/12 text-right pr-4 text-white">
                      ...
                      <h3 className="text-2xl text-black font-semibold montserrat-font-medium">
                        {item.title}
                      </h3>
                      <p className="montserrat-font-medium text-black">
                        {item.description}
                      </p>
                    </div>
                    {/* Center dot */}
                  ...
                  <>
                    ...
                    <div className="w-5/12 pl-4 text-left text-white">
                      ...
                      <h3 className="text-2xl font-semibold montserrat-font-medium text-black">
                        {item.title}
                      </h3>
                      <p className="montserrat-font-medium text-black">
                        {item.description}
