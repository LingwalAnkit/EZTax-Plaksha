      ...
      {isOpen && (
        <div className="fixed bottom-20 right-6 w-[350px] sm:w-[400px] bg-white/30 backdrop-blur-md rounded-2xl shadow-2xl flex flex-col z-50 h-[500px]">
          ...
          <div className="flex items-center justify-between px-4 py-3 border-b">
            <h2 className="text-xl montserrat-font-medium text-neutral-600">
              Ask the Tax Bot
            </h2>
            <button
          ...
          {/* Chat History */}
          <div className="flex-1 max-h-100 overflow-y-auto px-4 py-2 scrollbar-hide text-neutral-600">
            {chatHistory.map((msg, i) => (
              ...
              >
                <div className="inline-block montserrat-font-medium  bg-gray-600 px-3 py-2 rounded-lg max-w-[80%] text-md ">
          ...
          {/* Input Area */}
          <div className="flex gap-2 p-2 montserrat-font-medium text-neutral-600">
            <input
              value={userMessage}
              onChange={(e) => setUserMessage(e.target.value)}
              onKeyDown={handleKeyDown}
              className="flex-1 border rounded-2xl px-3 py-2 focus:outline-none "
